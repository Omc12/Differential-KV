...
**The previous edition of this file is retired.** It covered commits
`a5289a18..7c63bdca` and everything in it has either been ported, retracted, or
folded into the code as comments. Two of its conclusions are load-bearing for
what follows and are restated here rather than dropped — see "Carried forward"
below. The rest is in git history.
