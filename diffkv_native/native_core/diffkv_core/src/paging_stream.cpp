// diffkv_core/src/paging_stream.cpp
// Fallback implementation of paging stream for non-CUDA systems.

#include "native_core/diffkv_core/include/paging_stream.hpp"
#include <cstring>
...
void DiffKVPagingStream::sync_to_compute_stream(uint32_t block_id, void* compute_stream) {
    (void)block_id;
    (void)compute_stream;
