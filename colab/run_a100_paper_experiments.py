...
def exp3_long_context_quality(model_id: str) -> Dict[str, Any]:
    ...
    eval_prompts = [
        ...
        {"doc": "Berry Paper", "context": load_file_text(BERRY_PAPER_PATH),
         "q": "What physical phenomenon or degeneracy type is analyzed in the text?",
         "concepts": ["nonhermitian|non-hermitian|exceptional points|degeneracies|pseudohermitian"]},
