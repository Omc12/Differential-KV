...
seed 42, PREFIX-{1000..9999}-SUFFIX) through the PRODUCTION CUDA DKV path at
...
Run (transformers MUST be 4.46.3):
  DKV_TELEMETRY=1 python colab/dkv_code_fidelity.py --model Qwen/Qwen2.5-0.5B-Instruct
  # DKV_TELEMETRY=1 prints "[DKV DEBUG] Rule 1b skip block ..." for the needle block.
"""
