// mac_utils.hpp
// Apple Silicon (Metal / CPU) compatibility layer for DKV native.
...
//   1. Metal/MPS  — Apple Silicon M-series (always true in dkv_native on Mac)
...
// In dkv_native (llama.cpp-based), we are always Metal on Mac.
