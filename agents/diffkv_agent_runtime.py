"""
agents/diffkv_agent_runtime.py
...
class DiffKVAgentRuntime:
    def __init__(self, model_adapter: Any, diffkv_config: Dict[str, Any]):
        self.adapter = model_adapter
        self.config = diffkv_config
    ...
    def run_task(self, goal: str, max_steps: int = 10):
        ...
        """
        print(f"[DiffKVAgentRuntime] Starting task: {goal}")
        context = f"Goal: {goal}\n"
