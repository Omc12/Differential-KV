...
The bounded store reaches $64$k context on an $8.6$\,GB Apple~M3, where a standard full-KV cache
exhausts memory at $16$k, and the residuals recover a buried passcode exactly at every context.
Evaluated on Qwen2.5-1.5B (int4).
