...
\emph{anchor token} plus a rank-$16$ joint SVD \emph{delta}, paired with a bounded dense
recency window and a fused decode kernel that scores queries in low-rank space without
ever decompressing the cache. Evaluated on Qwen2.5-1.5B (int4) on an 8.6\,GB Apple~M3.
