...
buried passcode exactly from $4$k to $\reachK$k, and overtakes dense on long-context prefill---at a
measured cost in decode throughput that we report in full and localize to reconstruction-and-merge
overhead. The residual budget is an explicit dial between memory, accuracy, and speed. The most
