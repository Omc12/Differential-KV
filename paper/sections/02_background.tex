...
SVD~\cite{halko2011randomized} per block, and---unlike a latent attention---the runtime must
reconstruct attention from the factors at inference time, which is where the engineering
lies (\S\ref{sec:decode}).
