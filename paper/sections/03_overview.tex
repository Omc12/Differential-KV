...
\begin{figure}[t]
  ...
  \caption[\diffkv{} active-runtime architecture: serving stack, monkey-patched attention,
  and bounded block store.]{\diffkv{} active-runtime architecture. A serving stack (gateway,
  batching engine, session manager) drives \texttt{MLXDiffKVWrapper}, which runs chunked
...
layer: a \emph{dense recency window} of the most recent $\dwin{+}\bs{=}1{,}024$ tokens in exact
