...
class ValidationRunner20_3:
    def __init__(self, model, tokenizer):
        self.model = model
        self.tokenizer = tokenizer
        self.symbolic_suite = MultidomainSymbolicSuite(tokenizer)
        self.noise_injector = NoisyContextInjector()
        self.results_dir = "results/reconstruction_20_3"
        os.makedirs(self.results_dir, exist_ok=True)
        self.log_file = os.path.join(self.results_dir, "raw_steered_retrieval.jsonl")
    ...
    def run_suite(self):
        ...
        modes = ["dense", "sclcpp_20_2", "aascsi_20_3"]
...
if __name__ == "__main__":
    ...
    runner = ValidationRunner20_3(model, tokenizer)
