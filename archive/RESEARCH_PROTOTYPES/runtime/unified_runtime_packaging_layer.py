...
class UnifiedRuntimePackagingLayer:
    ...
    async def lgs_runtime_executor(
        ...
        return await self.resolver.lgs_runtime_executor(
            session_ids, payloads, session_manager=session_manager
        )
    ...
    async def lgs_runtime_stream_executor(
        ...
        async for chunk in self.resolver.lgs_runtime_stream_executor(
            session_ids, payloads, session_manager=session_manager
        ):
            yield chunk
