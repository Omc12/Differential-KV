...
print("--- Querying Python Server on 9100 with long prompt ---")
py_res = query_server(9100, long_prompt)
print(f"Python Response:\n{py_res}\n")

print("--- Querying C++ Server on 9099 with long prompt ---")
cpp_res = query_server(9099, long_prompt)
print(f"C++ Response:\n{cpp_res}\n")
