...
print("=== PHASE 4: RECONSTRUCTION STABILITY TEST ===")
...
# We configure the manager with a very small block size to force many compressions
# This stresses the reconstruction quality over a short sequence.
...
prompt = "Write a highly detailed, 500-word essay on the fall of the Roman Empire, including dates, key figures, and economic factors."
...
print(f"[2] Running Decode (Target: 150 tokens to force multiple compressions)...")
...
if mgr.total_compressions > 0:
    ...
    print("No compressions triggered!")
