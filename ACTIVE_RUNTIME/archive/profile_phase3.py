...
decode_input = torch.tensor([[out.logits[0, -1, :].argmax().item()]], device="cuda")
...
prof.export_chrome_trace("phase3_triton_trace.json")
print("Profiler trace saved to phase3_triton_trace.json")
