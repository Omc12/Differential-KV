...
2. **Hugging Face Cache is Dead.**
   The HF `past_key_values` mechanism is successfully severed and bypassed. The DKV interceptor successfully forces `past_key_values = None`, permanently preventing HF from allocating a dense canonical cache.
